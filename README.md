# DevDesk Theme for Jekyll

A professional, shareable Jekyll template for documentation hubs, help centers, and lightweight blogs.
...
Update `_config.yml` with your own:

- `title`, `description`, and `hero_subheading`
- `nav_links` (header navigation)
- `home_posts_limit` (how many cards show before “More articles”)

## Content workflow

Create new posts in `_posts/` named:
...
- `_config.yml` – site and template configuration
- `_layouts/` – shared and post layouts
- `_posts/` – markdown content
- `assets/css/` – images, stylesheets and javascript

---

<a href="https://themes.3rdwavemedia.com/bootstrap-templates/free/devdesk-free-boo…oftware-products/" target="_blank"><img src="https://themes.3rdwavemedia.com/wp-content/uploads/2024/07/Bootstrap-Knowledge-Base-Template-DevDesk-Pormo.jpg" alt="DevDesk - Bootstrap Knowledge Base & Help Centre Template for Tech Products" /></a>
